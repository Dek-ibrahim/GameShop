...
const BookingTicket = ({ bookingDetails }) => {
  return (
    <div className="my-4 rounded-lg mx-auto bg-blue-500 w-full md:w-[500px] text-white p-4 text-start ">
      ...
      <div className="mb-4 md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto">
        ...
        <p className="mb-2 md:mb-1">Email: {bookingDetails.email}</p>
        <p>Phone: {bookingDetails.phone}</p>
      </div>

      <div className="mb-4">
        <h3 className="text-lg font-bold mb-2">Selected Seats</h3>
        <p>{bookingDetails.selectedSeats.length > 0 ? bookingDetails.selectedSeats.join(', ') : 'None'}</p>
      </div>
